        ...
        children=[
            ...
            html.Div(
                ...
                children=[
                    ...
                    html.A(
                        'Andres Felipe Escallon Portilla (based and adapted from Chulong Li´s original app)',
...
def update_graph_live(n):
    ...
    print("1 df:\n", df.head())
    # Convert UTC into PDT (PDT=UTC-7)
    ...
    # This table must be created before in PgAdmin (it is not the same as twitter, it is in fact an aux table to show results transformed from the twitter table):
    ...
    children = [
                ...
                html.Div(
                    ...
                    children=[
                        ...
                        html.Div(
                            children=[
                                html.P("Currently tracking \"teleperformance\" on Twitter in Pacific Daylight Time (PDT=UTC-7).",
                                    style={
                                        'fontSize': 22
                                    }
                                ),
...
def update_graph_bottom_live(n):
    ...
    stop_words=set(stopwords.words("english"))# se puede cambiar de idioma dependiendo del país escogido
    filtered_sent=[]
